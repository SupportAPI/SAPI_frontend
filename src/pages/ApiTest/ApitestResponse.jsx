  ...
  useEffect(() => {
    if (initialData) {
      setResultData({
        status: 'success',
        code: 200,
        responseBody: '{"formData":{},"fileSize":56067,"fileOriginalName":"푸바오.jpg"}',
        mockBody: '{    "formData": {},    "fileSize": 56067,    "fileOriginalName": "푸바오.jpg"}',
        headers: {
          'Content-Type': 'application/json',
          'Transfer-Encoding': 'chunked',
          Date: 'Mon, 11 Nov 2024 06:01:34 GMT',
          ...
          <div className='flex flex-row justify-between gap-10'>
            <div className='flex flex-col w-full'>
              ...
              <div className='border w-full p-4'>
                <pre>{parsedBody ? JSON.stringify(parsedBody, null, 2) : 'No data'}</pre>
              </div>
            </div>
            <div className='flex flex-col w-full'>
              <p className='text-xl ml-1 mb-1'>MOCK RESPONSE</p>
              <div className='border w-full p-4'>
                <pre>{parsedMockBody ? JSON.stringify(parsedMockBody, null, 2) : 'No data'}</pre>
              </div>
            </div>
          </div>
        );
