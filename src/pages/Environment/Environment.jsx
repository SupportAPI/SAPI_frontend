...
const DropdownMenu = ({ onClose, position, setIsSecreted }) => {
    ...
    return (
        ...
        >
            <li className="p-2 hover:bg-gray-100 cursor-pointer text-center" onClick={() => sendIsSecreted(true)}>Secret</li>
            <li className="p-2 hover:bg-gray-100 cursor-pointer text-center" onClick={() => sendIsSecreted(false)}>Default</li>
        </ul>
    );
};
